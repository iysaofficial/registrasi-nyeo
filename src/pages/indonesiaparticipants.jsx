...
function IndoensiaParticipants() {
  ...
  const generatePaymentLink = async () => {
    if (
      selectedCategory !== "NYEO Online Competition" &&
      selectedCategory !== "NYEO Offline Competition" 
    ) {
      alert(
  ...
  useEffect(() => {
    if (selectedCategory === "NYEO Online Competition") {
      setPrice("300000");
    } else if (selectedCategory === "NYEO Offline Competition") {
      setPrice("1150000");
    } else {
      setPrice("");
    }
  ...
  useEffect(() => {
    const scriptURL =
      "https://script.google.com/macros/s/AKfycbwLe2jTE_3gTCzNbEWayXKWWLA-ljRWjEg68eKHoMp0AkqDWD4tK7hZfJ4W3l21lwL0/exec";
      ...
      <section className="registration-section">
        <div className="container">
          <div className="content">
            ...
            <br></br>
            <h4>
              HALLO PESERTA NYEO 2024, Mohon perhatikan informasi berikut ini
              ...
              <div className="user-details">
                <div className="input-box">
                  ...
                  >
                    ...
                    <option value="NYEO Online Competition">
                      Kompetisi Online
                    </option>
                    <option value="NYEO Offline Competition">
                      Kompetisi Offline
                    </option>
                  </select>
                </div>
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  <label for="SUMBER_INFORMASI" className="form-label">
                    Sumber Informasi Kompetisi NYEO 2024
                  </label>
                  <select
                    type="text"
                    id="SUMBER_INFORMASI"
